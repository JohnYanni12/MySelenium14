...
//
            ...
            //        check the checkBox that contains "screen saver" as a product
//            List<WebElement> secondColumn1 = driver.findElements(By.xpath("//table[@class='SampleTable']/tbody/tr/td[3]"));
////        traverse through the list
//
//            for (i = 0; i < secondColumn1.size(); i++) {
//                String text = secondColumn1.get(i).getText();
//
